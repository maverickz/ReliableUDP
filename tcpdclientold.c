...
main(int argc, char *argv[])
{
	...
	struct packet controlmessage; // used to send control msgs to client
	struct packet request_packet; // used to recv acks
	...
	fd_set read_fds; // variable for select
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////// create socket for communicating control msgs ////////////////////////////////////////////////////////////// 
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//// CREATE LOCAL SOCKET ----------to receive file from ftpc
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	////////  BIND IT TO PORT NUMBER THAT IT CAN RECEIVE FROM THE FTP CLIENT
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	////// PREPARE troll header......getting the troll to send msgs to port number destination	
	...
	////////  BIND IT TO PORT NUMBRT 14000 SO THAT IT CAN RECEIVE FROM TCPD SERVER
	...
	bytes_recvd=1;    
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//  INITIALIZE ALL RECEVING SOCKETS
	FD_ZERO(&read_fds);
	...
	while (1)
	{
		...
		{							
			...
			{
				printf("\n===== WINDOW IS FULL =====SLEEP SENT TO CLIENT\n");
			...
			{
				printf("\n WINDOW IS EMPTY-------DONT STOP SENT TO CLIENT\n");
